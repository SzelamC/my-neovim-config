...
local icon = require('cosmic.theme.icons')
local config = {}

-- default statusline icon
config.statusline = {
  main_icon = icon.ghost,
}
...
-- 'onedark'
-- 'rose-pine'
config.theme = 'onedark' -- don't define or set to nil, if you want to enable your own theme in cosmic/config/plugins.lua
